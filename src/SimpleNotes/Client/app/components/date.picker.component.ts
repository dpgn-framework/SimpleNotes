...
//https://embed.plnkr.co/xXt9wKs7jzpaivQeLjbx/

@Component({
    selector: 'sn-datepicker',
    providers: [DatePipe],
    templateUrl: 'app/components/date.picker.component.html',
    styles: [`
    .dp-popup {
        position: absolute;
        padding:10px;
...
export class SnDatepickerComponent implements AfterViewInit {
